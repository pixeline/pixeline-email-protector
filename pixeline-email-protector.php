...
if (!class_exists('WP_Email_Protector')) {
    class WP_Email_Protector
    {
         ...
         */
        public $optionsName = 'p_email_protector_options';
         ...
         */
        public $localizationDomain = "p_email_protector";
        ...
        public function admin_options_page()
        {
            if ($_POST['p_email_protector_save']) {
                if (!wp_verify_nonce($_POST['_wpnonce'], 'p_email_protector-update-options')) {
