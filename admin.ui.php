...
<blockquote><?php _e('Example: let\'s imagine you\'ve written in your post: ');?><code>Contact John: john@doe.com</code>. <?php _e('This email address could be spotted and used by spambots. This plugin will automatically convert it to', 'pxln_email_protector');?>
